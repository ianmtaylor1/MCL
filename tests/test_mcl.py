...
if __name__=='__main__':
    ...
    E1 = mcl.param_iter(tail=2)
    R1 = mcl.param_iter(tail=2)
    print(mcl.MCL(M1,E1,R1,labels=labels1))
    ...
    E2 = mcl.param_iter(tail=2)
    R2 = mcl.param_iter(tail=2)
    print(mcl.MCL(M2,E2,R2,labels=labels2))